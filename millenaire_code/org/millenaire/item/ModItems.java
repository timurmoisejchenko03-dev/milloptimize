...
public final class ModItems {
    ...
    static {
        for (DyeColor color : DyeColor.values()) {
            PAINTED_BRICK_ITEMS.put(color, (DeferredItem<BlockItem>)ITEMS.registerSimpleBlockItem((Holder)ModBlocks.PAINTED_BRICKS.get(color)));
            DECORATED_BRICK_ITEMS.put(color, (DeferredItem<BlockItem>)ITEMS.registerSimpleBlockItem((Holder)ModBlocks.DECORATED_BRICKS.get(color)));
            PAINTED_BRICK_STAIRS_ITEMS.put(color, (DeferredItem<BlockItem>)ITEMS.registerSimpleBlockItem((Holder)ModBlocks.PAINTED_BRICK_STAIRS.get(color)));
            PAINTED_BRICK_SLAB_ITEMS.put(color, (DeferredItem<BlockItem>)ITEMS.registerSimpleBlockItem((Holder)ModBlocks.PAINTED_BRICK_SLABS.get(color)));
            PAINTED_BRICK_WALL_ITEMS.put(color, (DeferredItem<BlockItem>)ITEMS.registerSimpleBlockItem((Holder)ModBlocks.PAINTED_BRICK_WALLS.get(color)));
        }
