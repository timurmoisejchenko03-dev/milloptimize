...
public final class WaypointDiagCommand {
    ...
    private static void emitVillageSection(CommandSourceStack source, WaypointDiagnostics.Report report) {
        ...
        String header = "\u2500\u2500 " + String.valueOf(v.getVillageTypeId()) + " @ " + v.getCenter().toShortString() + " \u2014 " + report.probedCount() + " probed, " + report.findings().size() + " unreachable (" + report.anchors().size() + " anchors)";
