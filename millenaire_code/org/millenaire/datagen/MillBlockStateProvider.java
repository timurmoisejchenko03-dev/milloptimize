...
extends BlockStateProvider {
    ...
    private void registerPaintedBricks() {
        for (DyeColor color : DyeColor.values()) {
            ...
            this.simpleBlockWithItem((Block)ModBlocks.PAINTED_BRICKS.get(color).get(), this.cubeAll((Block)ModBlocks.PAINTED_BRICKS.get(color).get()));
            ...
            this.simpleBlockWithItem((Block)ModBlocks.DECORATED_BRICKS.get(color).get(), (ModelFile)decoratedModel);
            this.stairsWithItem(ModBlocks.PAINTED_BRICK_STAIRS.get(color), texture);
            this.slabWithItem(ModBlocks.PAINTED_BRICK_SLABS.get(color), "painted_brick_" + colorName + "_slab", texture, this.modLoc("block/painted_brick_" + colorName));
            this.wallWithItem(ModBlocks.PAINTED_BRICK_WALLS.get(color), "painted_brick_" + colorName + "_wall", texture);
        }
    }
