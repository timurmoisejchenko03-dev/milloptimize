...
public interface Resource {
    ...
    public record FileResource(String relPath, SourceLabel source, SourceKind kind, Path path, ContentFs owner) {
        public FileResource {
            if (relPath == null) {
    ...
    public record ClasspathResource(String relPath, SourceLabel source, SourceKind kind, Path path, ContentFs owner) {
