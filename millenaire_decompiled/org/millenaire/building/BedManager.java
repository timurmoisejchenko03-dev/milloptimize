...
public class BedManager {
    ...
    public void add(BlockPos footPos) {
        if (!this.bedPositions.contains((Object)footPos)) {
    ...
    public void remove(BlockPos footPos) {
        if (this.bedPositions.remove((Object)footPos)) {
            this.claimedBeds.remove((Object)footPos);
            this.suffocatingExpiry.remove((Object)footPos);
            this.dirty = true;
        }
    }
    ...
    public boolean claimBed(BlockPos footPos, UUID villagerUuid) {
        ...
        if (this.claimedBeds.containsKey((Object)footPos)) {
            return false;
        }
    ...
    public void releaseBed(BlockPos footPos) {
        if (this.claimedBeds.remove((Object)footPos) != null) {
            this.dirty = true;
        }
    }
    ...
    public Optional<BlockPos> findNearestUnclaimedBed(BlockPos origin, double maxDistance, long nowGameTime) {
        ...
        for (BlockPos pos : this.bedPositions) {
            double distSq;
            if (this.claimedBeds.containsKey((Object)pos) || nowGameTime > 0L && this.isSuffocatingMarked(pos, nowGameTime) || (distSq = origin.distSqr((Vec3i)pos)) > maxDistSq || !(distSq < bestDistSq)) continue;
            bestDistSq = distSq;
            best = pos;
        }
    ...
    public boolean isSuffocatingMarked(BlockPos footPos, long nowGameTime) {
        Long expiry = this.suffocatingExpiry.get((Object)footPos);
        if (expiry == null) {
            return false;
        }
    ...
    public void clearSuffocating(BlockPos footPos) {
        if (this.suffocatingExpiry.remove((Object)footPos) != null) {
            this.dirty = true;
        }
    }
    ...
    public boolean validate(ServerLevel level, Set<UUID> knownVillagerUuids) {
        ...
        while (posIt.hasNext()) {
            ...
            posIt.remove();
            this.claimedBeds.remove((Object)pos);
            this.suffocatingExpiry.remove((Object)pos);
            changed = true;
        }
    ...
    public ListTag save() {
        ...
        for (BlockPos pos : this.bedPositions) {
            ...
            UUID owner = this.claimedBeds.get((Object)pos);
            if (owner != null) {
                entry.putUUID(KEY_UUID, owner);
            }
            if ((expiry = this.suffocatingExpiry.get((Object)pos)) != null) {
