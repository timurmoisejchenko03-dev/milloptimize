...
public final class ModBlocks {
    ...
    static {
        for (DyeColor color : DyeColor.values()) {
            ...
            PAINTED_BRICK_STAIRS.put(color, (DeferredBlock<Block>)BLOCKS.register(name + "_stairs", key -> new PaintedBrickStairBlock(color, ((Block)PAINTED_BRICKS.get((Object)color).get()).defaultBlockState(), BlockBehaviour.Properties.of().mapColor(color.getMapColor()).strength(1.5f, 10.0f).sound(SoundType.STONE).requiresCorrectToolForDrops())));
