...
import org.millenaire.world.OliveTreeGenerator;

public class OliveTreeSaplingBlock
extends BushBlock
implements BonemealableBlock {
    ...
    public static final MapCodec<OliveTreeSaplingBlock> CODEC = OliveTreeSaplingBlock.simpleCodec(OliveTreeSaplingBlock::new);
    ...
    public void advanceTree(ServerLevel level, BlockPos pos, BlockState state, RandomSource random) {
        if ((Integer)state.getValue((Property)STAGE) == 0) {
            ...
            OliveTreeGenerator.generate(level, pos, random);
        }
    }
