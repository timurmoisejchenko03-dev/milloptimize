...
import org.millenaire.world.PistachioTreeGenerator;

public class PistachioTreeSaplingBlock
extends BushBlock
implements BonemealableBlock {
    ...
    public static final MapCodec<PistachioTreeSaplingBlock> CODEC = PistachioTreeSaplingBlock.simpleCodec(PistachioTreeSaplingBlock::new);

    public PistachioTreeSaplingBlock(BlockBehaviour.Properties properties) {
        super(properties);
    ...
    public void advanceTree(ServerLevel level, BlockPos pos, BlockState state, RandomSource random) {
        if ((Integer)state.getValue((Property)STAGE) == 0) {
            ...
            PistachioTreeGenerator.generate(level, pos, random);
        }
    }
