...
public class MockAnimalSpawnBlock
extends MockBlock {
    public static final EnumProperty<AnimalSpawnType> ANIMAL = EnumProperty.create((String)"animal", AnimalSpawnType.class);
    ...
    public MockAnimalSpawnBlock(BlockBehaviour.Properties properties) {
        super(properties);
        this.registerDefaultState((BlockState)((BlockState)this.stateDefinition.any()).setValue(ANIMAL, (Comparable)((Object)AnimalSpawnType.COW)));
    }
    ...
    public SpecialPoint toSpecialPoint(BlockState state, BlockPos pos) {
        AnimalSpawnType animal = (AnimalSpawnType)((Object)state.getValue(ANIMAL));
