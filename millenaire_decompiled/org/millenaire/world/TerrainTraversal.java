...
public final class TerrainTraversal {
    ...
    extends Enum<Action> {
        public static final /* enum */ Action CLEAR_AIR = new Action();
        public static final /* enum */ Action CLEAR_TREE = new Action();
        public static final /* enum */ Action FILL_SUBSURFACE = new Action();
        public static final /* enum */ Action FILL_SURFACE = new Action();
        public static final /* enum */ Action BORDER_ANTIFLOOD = new Action();
        public static final /* enum */ Action CLEAR_SUBGROUND = new Action();
        public static final /* enum */ Action STABILIZE_FALLING = new Action();
        ...
        private static /* synthetic */ Action[] $values() {
            return new Action[]{CLEAR_AIR, CLEAR_TREE, FILL_SUBSURFACE, FILL_SURFACE, BORDER_ANTIFLOOD, CLEAR_SUBGROUND, STABILIZE_FALLING};
        }
