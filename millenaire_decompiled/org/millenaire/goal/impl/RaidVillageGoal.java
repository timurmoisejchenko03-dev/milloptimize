...
public class RaidVillageGoal
implements VillagerGoal {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath((String)"millenaire", (String)"raid_village");
    ...
    public VillagerTask start(GoalContext context) {
        return new RaidVillageTask();
    }

    static class RaidVillageTask
    implements VillagerTask {
        ...
        private static final double ACQUIRE_RADIUS = 10.0;
        private static final double FALLBACK_ARRIVE_SQ = 4.0;
        ...
        public void tick(GoalContext ctx) {
            ...
            CombatGoalSupport.tickCombat(v, this.defendingPos, 10.0, 0.7, 4.0, RaidVillageTask::isDefender);
        }

        private static boolean isDefender(MillVillager other) {
            if (other.isRaiderEntity()) {
                return false;
            }
            VillagerType t = ModCultures.getVillagerType(other.getVillagerTypeId());
