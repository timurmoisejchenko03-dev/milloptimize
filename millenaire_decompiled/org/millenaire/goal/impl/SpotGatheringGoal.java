...
implements VillagerGoal {
    ...
    extends Enum<StockSource> {
        public static final /* enum */ StockSource NONE = new StockSource();
        public static final /* enum */ StockSource TOWNHALL = new StockSource();
        public static final /* enum */ StockSource FARM = new StockSource();
        private static final /* synthetic */ StockSource[] $VALUES;
        ...
        public static StockSource valueOf(String name) {
            return Enum.valueOf(StockSource.class, name);
        }

        private static /* synthetic */ StockSource[] $values() {
            return new StockSource[]{NONE, TOWNHALL, FARM};
        }

        static {
            $VALUES = StockSource.$values();
        }
    }
