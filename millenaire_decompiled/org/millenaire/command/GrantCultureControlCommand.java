...
public final class GrantCultureControlCommand {
    ...
    private static int grantControl(CommandContext<CommandSourceStack> ctx) {
        ...
        source.sendSuccess(() -> Component.literal((String)("Granted " + String.valueOf((Object)cultureId) + " control to " + profile.getName())), true);
        return 1;
    }
    ...
    private static int revokeControl(CommandContext<CommandSourceStack> ctx) {
        ...
        source.sendSuccess(() -> Component.literal((String)("Revoked " + String.valueOf((Object)cultureId) + " control from " + profile.getName())), true);
        return 1;
    }
}
